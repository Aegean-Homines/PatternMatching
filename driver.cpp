...
void test0() {
    ...
    // all transitions that are not on the diagram go to 0
	//              +-a-+
	//              |   |
	//           a   \ /   b      a       c
	//        0 ----> 1 ----> 2----> 3 ----> 4
...
void test2() {
	...
	std::cout << "Brute-force time " << elapsed_seconds.count() << std::endl;
#endif
	...
	std::cout << "FSM time " << elapsed_seconds.count() << std::endl;
#endif
